module github.com/ironzhang/superdns

go 1.16

require (
	github.com/ironzhang/superlib v0.0.0-20240201034449-12e1ac9535be // indirect
	github.com/ironzhang/tapp v0.0.0-20240111031358-39164a99f46b // indirect

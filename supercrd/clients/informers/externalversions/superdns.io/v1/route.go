	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SuperdnsV1().Routes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SuperdnsV1().Routes(namespace).Watch(context.TODO(), options)
			},
		},
		&superdnsiov1.Route{},
		resyncPeriod,
...
func (f *routeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&superdnsiov1.Route{}, f.defaultInformer)
}

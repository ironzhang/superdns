...
import (
	...
	internalinterfaces "github.com/ironzhang/superdns/supercrd/clients/informers/externalversions/internalinterfaces"
	v1 "github.com/ironzhang/superdns/supercrd/clients/listers/superdns.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SuperdnsV1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SuperdnsV1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&superdnsiov1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&superdnsiov1.Cluster{}, f.defaultInformer)
}
